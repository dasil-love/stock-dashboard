...
KR_TICKERS = {
    ...
    # 한국 Hot ETF (Hot ETF 페이지 목록과 동일 - 한국주식 대시보드에서도 검색 가능하도록)
    "TIGER 미국S&P500": "360750.KS",
    "TIGER 미국나스닥100": "133690.KS",
    "TIGER 반도체TOP10": "396500.KS",
    "KODEX 반도체": "091160.KS",
    "HANARO Fn K-반도체": "395270.KS",
    "TIGER 반도체": "091230.KS",
    "KODEX AI전력핵심설비": "487240.KS",
    "TIGER 코리아AI전력기기TOP3플러스": "0117V0.KS",
    "TIGER K방산&우주": "463250.KS",
    "KODEX 방산TOP10": "0080G0.KS",
    "ACE 원자력TOP10": "433500.KS",
    "TIGER 코리아원자력": "0091P0.KS",
    "HANARO 원자력iSelect": "434730.KS",
    "KODEX 원자력SMR": "0098F0.KS",
    "KODEX 신재생에너지액티브": "385510.KS",
    "TIGER Fn신재생에너지": "377990.KS",
    "KODEX 2차전지산업": "305720.KS",
    "TIGER 2차전지테마": "305540.KS",
    "KODEX 자동차": "091180.KS",
    "SOL 자동차TOP3플러스": "466930.KS",
    "KODEX 미국AI광통신네트워크": "0173Y0.KS",
    "TIGER 미국우주테크": "0183J0.KS",
    "TIGER 증권": "157500.KS",
    "TIGER 코리아TOP10": "292150.KS",
    "KODEX 미국AI테크TOP10": "855540.KS",  # 야후 파이낸스에 아직 등록되지 않아 조회가 안 될 수 있음
    "KODEX 미국AI소프트웨어TOP10": "0041D0.KS",
...
KR_SECTOR_STOCKS = {
    "반도체": ["SK하이닉스", "삼성전자", "SK스퀘어", "한미반도체", "DB하이텍", "원익IPS", "유진테크", "테스",
             ...
             "TIGER 반도체TOP10", "KODEX 반도체", "HANARO Fn K-반도체", "TIGER 반도체"],
    "전력설비/원자력": ["두산에너빌리티", "LS ELECTRIC", "HD현대일렉트릭", "효성중공업", "한국전력", "LS",
                   "대한전선", "가온전선", "신일전자", "일진전기", "한전기술", "우리기술",
                   "KODEX AI전력핵심설비", "TIGER 코리아AI전력기기TOP3플러스", "ACE 원자력TOP10",
                   "TIGER 코리아원자력", "HANARO 원자력iSelect", "KODEX 원자력SMR"],
    "제약/바이오": ["삼성바이오로직스", "SK바이오사이언스", "셀트리온", "휴젤", "한미약품", "알테오젠"],
    "자동차": ["현대자동차", "기아", "현대모비스", "HL만도", "현대위아", "한국타이어앤테크놀로지",
             "KODEX 자동차", "SOL 자동차TOP3플러스"],
    "2차전지/신재생": ["삼성SDI", "LG에너지솔루션", "SK이노베이션", "에코프로", "에코프로비엠", "POSCO홀딩스",
                  "RFHIC", "나노신소재", "포스코퓨처엠", "엘앤에프", "천보", "롯데에너지머티리얼즈",
                  "솔루스첨단소재", "SKC", "KODEX 2차전지산업", "TIGER 2차전지테마",
                  "KODEX 신재생에너지액티브", "TIGER Fn신재생에너지"],
    ...
    "우주방산": ["한화에어로스페이스", "한국항공우주", "LIG넥스원", "한화시스템", "한화", "TIGER 미국우주테크"],
    "식료건강": ["삼양식품", "농심", "오리온", "CJ제일제당", "삼양사", "노바렉스", "한국콜마",
              "콜마비앤에이치", "코스맥스", "코스메카코리아"],
    "기타": ["신대양제지", "디어유", "포스코인터내셔널"],
}

# 위 KR_SECTOR_STOCKS에 섞여있는 종목명 중 ETF인 것들 (개별 종목과 구분해서 필요한 곳에서 걸러내는 용도)
KR_SECTOR_ETF_NAMES = {
    "TIGER 반도체TOP10", "KODEX 반도체", "HANARO Fn K-반도체", "TIGER 반도체",
    "KODEX AI전력핵심설비", "TIGER 코리아AI전력기기TOP3플러스", "ACE 원자력TOP10",
    "TIGER 코리아원자력", "HANARO 원자력iSelect", "KODEX 원자력SMR",
    "KODEX 2차전지산업", "TIGER 2차전지테마", "KODEX 신재생에너지액티브", "TIGER Fn신재생에너지",
    "KODEX 자동차", "SOL 자동차TOP3플러스", "TIGER 미국우주테크",
}
